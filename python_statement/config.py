...
SCRAPER_CONFIG = {
    ...
    'barrasso': {
        'method': 'generic',
        'url_base': 'https://www.barrasso.senate.gov/newsroom/news-releases/',
    ...
    'cassidy': {
        'method': 'generic',
        'url_base': 'https://www.cassidy.senate.gov/newsroom/press-releases/?jsf=jet-engine:press-list',
    ...
    'marshall': {
        'method': 'generic',
        'url_base': 'https://www.marshall.senate.gov/newsroom/press-releases/',
        'container': '.jet-listing-grid__item',
        'title_sel': 'h4 a',
        'date_sel': 'span.elementor-icon-list-text',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?jsf=jet-engine:list&pagenum={page}',
    },
    # britt moved to generic pattern below
    'toddyoung': {
        'method': 'generic',
        'url_base': 'https://www.young.senate.gov/newsroom/press-releases/',
        'container': '.jet-listing-grid__item',
        'title_sel': 'h2 a',
        'date_sel': 'span.elementor-icon-list-text',
        'date_fmt': ['%B %d, %Y'],
    ...
    'chrismurphy': {
        'method': 'generic',
        'url_base': 'https://www.murphy.senate.gov/newsroom/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'h1 a',
        'date_sel': 'span.ArticleBlock__date',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?PageNum_rs={page}',
    },
    'markey': {
        'method': 'generic',
        'url_base': 'https://www.markey.senate.gov/news/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'a.ArticleBlock__title__link',
        'date_sel': 'p.ArticleBlock__date',
        'date_fmt': ['%B %d, %Y'],
    },
    'cotton': {
        'method': 'generic',
        'url_base': 'https://www.cotton.senate.gov/news/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'a.ArticleTitle__link',
        'date_sel': 'p.ArticleBlock__date',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?PageNum_rs={page}',
    },
    'rounds': {
        'method': 'generic',
        'url_base': 'https://www.rounds.senate.gov/newsroom/press-releases',
        'container': 'div.ArticleBlock',
    ...
    'kaine': {
        'method': 'generic',
        'url_base': 'https://www.kaine.senate.gov/news',
        'container': 'div.ArticleBlock',
        'title_sel': 'a.ArticleTitle',
        'date_sel': 'p.Heading--overline',
        'date_fmt': ['%B %d %Y'],
        'pagination': '?PageNum_rs={page}',
    },
    ...
    'crapo': {
        'method': 'generic',
        'url_base': 'https://www.crapo.senate.gov/media/newsreleases',
        'container': 'div.ArticleBlock',
        'title_sel': 'h2.ArticleTitle',
        'link_sel': 'a[href]',
        'date_sel': 'p.Heading--time',
    ...
    'hirono': {
        'method': 'generic',
        'url_base': 'https://www.hirono.senate.gov/news/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'a.ArticleTitle',
        'date_sel': 'p.Heading--time',
        'date_fmt': ['%B %d, %Y'],
    ...
    'ernst': {
        'method': 'generic',
        'url_base': 'https://www.ernst.senate.gov/news/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'a',
        'date_sel': 'p.Heading--time',
        'date_fmt': ['%B %d, %Y'],
    ...
    'garypeters': {
        'method': 'generic',
        'url_base': 'https://www.peters.senate.gov/newsroom/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'a',
        'date_sel': 'p.Heading--time',
        'date_fmt': ['%m.%d.%Y'],
    ...
    'jackreed': {
        'method': 'generic',
        'url_base': 'https://www.reed.senate.gov/news/releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'heinrich': {
        'method': 'generic',
        'url_base': 'https://www.heinrich.senate.gov/newsroom/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'h2.ArticleTitle',
        'link_sel': 'a.ArticleBlock__link',
        'date_sel': 'p.Heading--time',
        'pagination': '?PageNum_rs={page}',
    },
    ...
    'bergman': {
        'method': 'generic',
        'url_base': 'https://bergman.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'cantwell': {
        'method': 'generic',
        'url_base': 'https://www.cantwell.senate.gov/news/press-releases',
        'container': 'table tr',
        'title_sel': 'td a',
        'date_sel': 'td',
        'date_fmt': ['%m/%d/%y'],
    ...
    'carey': {
        'method': 'generic',
        'url_base': 'https://carey.house.gov/press-releases/',
    ...
    'cortezmasto': {
        'method': 'generic',
        'url_base': 'https://www.cortezmasto.senate.gov/news/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': '.ArticleBlock__title a',
        'date_sel': 'time',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '',
    },
    'cruz': {
        'method': 'generic',
        'url_base': 'https://www.cruz.senate.gov/newsroom/press-releases',
        'container': 'a.ArticleBlock',
        'title_sel': 'h2',
        'date_sel': 'p.Heading--overline',
        'date_fmt': ['%m.%d.%Y'],
        'pagination': '?PageNum_rs={page}',
    ...
    'daines': {
        'method': 'generic',
        'url_base': 'https://www.daines.senate.gov/news/press-releases/',
        'container': 'article.elementor-post',
        'title_sel': 'h3 a',
        'date_sel': 'span.elementor-post-date',
        'date_fmt': ['%B %d, %Y'],
    ...
    'ellzey': {
        'method': 'generic',
        'url_base': 'https://ellzey.house.gov/',
        'container': 'a.update-link',
        'title_sel': 'div.post-title',
        'date_sel': 'span.date',
        'date_fmt': ['%B %d, %Y'],
        'base_domain': 'ellzey.house.gov',
    },
    'gimenez': {
        'method': 'generic',
        'url_base': 'https://gimenez.house.gov/',
        'container': 'article.update-content',
        'title_sel': 'a',
        'base_domain': 'gimenez.house.gov',
    },
    'hassan': {
        'method': 'generic',
        'url_base': 'https://www.hassan.senate.gov/news/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'coons': {
        'method': 'generic',
        'url_base': 'https://www.coons.senate.gov/news/press-releases/',
        'container': 'div.ArticleBlock',
        'title_sel': 'a.elementor-button',
        'date_sel': 'time',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?PageNum_rs={page}',
    },
    'hydesmith': {
        'method': 'generic',
        'url_base': 'https://www.hydesmith.senate.gov/newsroom',
        'container': '.views-row',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'lofgren': {
        'method': 'generic',
        'url_base': 'https://lofgren.house.gov/media/press-releases',
        'container': '.views-row',
        'title_sel': 'a[rel="bookmark"]',
        'pagination': '?page={page}',
    },
    ...
    'mikelee': {
        'method': 'generic',
        'url_base': 'https://www.lee.senate.gov/',
        'container': 'article.feature-content',
        'title_sel': 'h2.feature-title a',
    },
    'paul': {
        'method': 'generic',
        'url_base': 'https://www.paul.senate.gov/news/',
        'container': 'article.et_pb_post',
    ...
    'pressley': {
        'method': 'generic',
        'url_base': 'https://pressley.house.gov/news/',
        'container': 'a.post',
        'title_sel': 'p.title',
        'date_sel': 'p.date',
    ...
    'risch': {
        'method': 'generic',
        'url_base': 'https://www.risch.senate.gov/public/index.cfm/press-releases',
        'container': 'div.e-con.e-parent',
        'title_sel': 'h2 a',
        'date_sel': 'span.elementor-icon-list-text',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?PageNum_rs={page}',
    ...
    'ronjohnson': {
        'method': 'generic',
        'url_base': 'https://www.ronjohnson.senate.gov/press-releases',
    ...
    'schatz': {
        'method': 'generic',
        'url_base': 'https://www.schatz.senate.gov/news/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'a.Heading--h3',
        'date_sel': 'p.Heading--overline',
        'date_fmt': ['%m.%d.%Y'],
        'pagination': '?PageNum_rs={page}',
    },
    'shaheen': {
        'method': 'generic',
        'url_base': 'https://www.shaheen.senate.gov/news/press',
        'container': 'div.ArticleBlock',
        'title_sel': 'a',
        'date_sel': 'time.Heading--time',
        'date_fmt': ['%m.%d.%Y'],
        'pagination': '?PageNum_rs={page}',
    },
    'whitehouse': {
        'method': 'generic',
        'url_base': 'https://www.whitehouse.senate.gov/news/release',
        'container': 'div.ArticleBlock',
        'title_sel': '.ArticleBlock__title a',
    ...
    'hamadeh': {
        'method': 'generic',
        'url_base': 'https://hamadeh.house.gov/news/',
        'container': 'article.newsblocker',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
        'date_fmt': ['%Y-%m-%d'],
    ...
    'cline': {
        'method': 'generic',
        'url_base': 'https://cline.house.gov/news/documentquery.aspx?DocumentTypeID=27',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'nunn': {
        'method': 'generic',
        'url_base': 'https://nunn.house.gov/category/news/press-releases/',
        'container': 'article.et_pb_post',
        'title_sel': 'h1.entry-title a',
        'date_sel': 'span.published',
        'date_fmt': ['%b %d, %Y'],
        'pagination': 'page/{page}/',
    },
    ...
    'rulli': {
        'method': 'generic',
        'url_base': 'https://rulli.house.gov/category/press-releases/',
        'container': 'article.et_pb_post',
        'title_sel': 'h2 a',
        'date_sel': 'span.published',
        'date_fmt': ['%b %d, %Y'],
    ...
    'goodlander': {
        'method': 'generic',
        'url_base': 'https://goodlander.house.gov/media/press-releases/',
        'container': 'li.post',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'riley': {
        'method': 'generic',
        'url_base': 'https://riley.house.gov/news/',
        'container': 'article.et_pb_post',
        'title_sel': 'h3.entry-title a',
        'date_sel': 'span.published',
        'date_fmt': ['%b %d, %Y'],
        'pagination': 'page/{page}/',
    },
    ...
    'emmer': {
        'method': 'generic',
        'url_base': 'https://emmer.house.gov/media-center/press-releases',
    ...
    'foxx': {
        ...
        'date_attr': 'datetime',
        'date_fmt': ['%Y-%m-%d'],
        'pagination': '?DocumentTypeID=2367&Page={page}',
        'url_prefix': '/news/',
    },
    'gosar': {
        'method': 'generic',
    ...
    'houlahan': {
        'method': 'generic',
        'url_base': 'https://houlahan.house.gov/press/',
        'container': 'article.newsblocker',
        'title_sel': 'strong.title a',
        'date_sel': 'span.date',
    },
    'huizenga': {
        'method': 'generic',
        'url_base': 'https://huizenga.house.gov/news/',
        'container': 'article.newsblocker',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'jasonsmith': {
        'method': 'generic',
        'url_base': 'https://jasonsmith.house.gov/category/press_release/',
        'container': 'a.item',
        'title_sel': 'h3',
        'date_sel': 'span.date',
        'date_fmt': ['%B %d, %Y'],
    ...
    'mast': {
        'method': 'generic',
        'url_base': 'https://mast.house.gov/press-releases',
        'container': 'table tr',
        'title_sel': 'a.ContentGrid',
        'date_sel': 'td.recordListDate',
        'date_fmt': ['%m/%d/%y', '%m/%d/%Y'],
        'skip_first': 1,
        'pagination': '?PageNum_rs={page}',
        'base_domain': 'mast.house.gov',
    },
    'mcgovern': {
        'method': 'generic',
        'url_base': 'https://mcgovern.house.gov/news/',
        'container': 'article.newsblocker',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'norcross': {
        'method': 'generic',
        'url_base': 'https://norcross.house.gov/press-releases',
        'container': 'div.media-digest-body',
        'title_sel': 'a.media-digest-body-link',
        'date_sel': 'div.media-digest-header',
        'base_domain': 'norcross.house.gov',
    },
    'schweikert': {
        'method': 'generic',
        'url_base': 'https://schweikert.house.gov/category/congress_press_release/',
    ...
    'titus': {
        'method': 'generic',
        'url_base': 'https://titus.house.gov/news/',
        'container': 'article.newsblocker',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'rickscott': {
        'method': 'generic',
        'url_base': 'https://www.rickscott.senate.gov/press-releases/',
        'container': 'div.element',
        'title_sel': 'div.element-title',
        'link_sel': 'a',
        'date_sel': 'span.element-date',
        'date_fmt': ['%b %d'],
    },
    'welch': {
        'method': 'generic',
    ...
    'fetterman': {
        'method': 'generic',
        'url_base': 'https://www.fetterman.senate.gov/newsroom/',
        'container': 'article.elementor-post',
        'title_sel': 'h2.elementor-post__title a',
        'date_fmt': ['%B %d, %Y'],
    },
    'jayapal': {
        'method': 'generic',
        'url_base': 'https://jayapal.house.gov/category/press-releases/',
    ...
    'clarke': {
        'method': 'generic',
        'url_base': 'https://clarke.house.gov/category/press-release/',
        'container': '.post',
        'title_sel': 'h2',
        'link_sel': 'a',
        'date_sel': 'span.date',
    ...
    'crawford': {
        'method': 'generic',
        'url_base': 'https://crawford.house.gov/media/press-releases',
        'container': '.views-row',
        'title_sel': '.h3 a',
        'date_sel': '.col-auto',
        'date_fmt': ['%B %d, %Y'],
    ...
    'grijalva': {
        'method': 'generic',
        'url_base': 'https://grijalva.house.gov/media',
        'container': '.media-body',
        'title_sel': 'div.h3 a',
        'date_sel': '.col-auto',
        'date_fmt': ['%B %d, %Y'],
    ...
    'scanlon': {
        'method': 'generic',
        'url_base': 'https://scanlon.house.gov/news/',
        'container': 'article.newsblocker',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'bennet': {
        'method': 'generic',
        'url_base': 'https://www.bennet.senate.gov/news/page/',
        'container': 'article.et_pb_post',
        'title_sel': 'h3 a',
        'date_sel': 'p span.published',
        'date_fmt': ['%B %d, %Y', '%b %d, %Y'],
    ...
    'barragan': {
        'method': 'generic',
        'url_base': 'https://barragan.house.gov/news',
        'container': '.post',
        'title_sel': 'h2',
        'link_sel': 'a.btn',
        'date_sel': 'p.date',
    ...
    'tinasmith': {
        ...
        'container': 'article.elementor-post',
        'title_sel': 'h3.elementor-post__title a',
        'date_sel': 'span.elementor-post-date',
        'date_fmt': ['%B %d, %Y'],
    },
    'vanhollen': {
    ...
    'schmitt': {
        'method': 'generic',
        'url_base': 'https://www.schmitt.senate.gov/newsroom/press-releases/',
        'container': '.jet-listing-grid__item',
        'title_sel': 'a.jet-listing-dynamic-link__link',
        'date_sel': '.overline h3',
        'date_fmt': ['%B %d, %Y'],
    },
    ...
    'wassermanschultz': {
        'method': 'generic',
        'url_base': 'https://wassermanschultz.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'hern': {
        'method': 'generic',
        'url_base': 'https://hern.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
    ...
    'fletcher': {
        'method': 'generic',
        'url_base': 'https://fletcher.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_attr': 'datetime',
