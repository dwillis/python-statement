...
SCRAPER_CONFIG = {
    ...
    'cardin': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.cardin.senate.gov/newsroom/press-releases'},
    'carper': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.carper.senate.gov/news/press-releases'},
    'casey': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.casey.senate.gov/news/releases'},
    'coons': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.coons.senate.gov/news/press-releases'},
    'hydesmith': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.hydesmith.senate.gov/media/press-releases'},
    'lankford': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.lankford.senate.gov/news/press-releases'},
    'lofgren': {'method': 'article_block_h2_p_date', 'url_base': 'https://lofgren.house.gov/media/press-releases'},
    'lucas': {'method': 'article_block_h2_p_date', 'url_base': 'https://lucas.house.gov/media-center/press-releases'},
    'manchin': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.manchin.senate.gov/newsroom/press-releases'},
    'robmenendez': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.menendez.senate.gov/newsroom/press'},
    'merkley': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.merkley.senate.gov/news/press-releases'},
    'mikelee': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.lee.senate.gov/news/press-releases'},
    'mooney': {'method': 'article_block_h2_p_date', 'url_base': 'https://mooney.house.gov/media/press-releases'},
    'paul': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.paul.senate.gov/news/press'},
    'pressley': {'method': 'article_block_h2_p_date', 'url_base': 'https://pressley.house.gov/media/press-releases'},
    'reschenthaler': {'method': 'article_block_h2_p_date', 'url_base': 'https://reschenthaler.house.gov/media/press-releases'},
    'risch': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.risch.senate.gov/public/index.cfm/press-releases'},
    'ronjohnson': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.ronjohnson.senate.gov/press-releases'},
    'schatz': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.schatz.senate.gov/news/press-releases'},
    'shaheen': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.shaheen.senate.gov/news/press'},
    'stabenow': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.stabenow.senate.gov/news'},
    'whitehouse': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.whitehouse.senate.gov/news/release'},
    'wyden': {'method': 'article_block_h2_p_date', 'url_base': 'https://www.wyden.senate.gov/news/press-releases'},
    ...
    'baldwin': {
        'method': 'generic',
        'url_base': 'https://www.baldwin.senate.gov/news/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'h2.ArticleTitle',
        'link_sel': 'a',
        'date_sel': 'p.Heading--time',
        'date_fmt': ['%m.%d.%y', '%m.%d.%Y', '%m/%d/%y', '%B %d, %Y'],
        'pagination': '?PageNum_rs={page}&',
    },
    'schumer': {
        'method': 'generic',
        'url_base': 'https://www.schumer.senate.gov/newsroom/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': '.ArticleTitle',
        'link_sel': 'a',
        'date_sel': 'p.Heading--time',
        'date_fmt': ['%B %d, %Y', '%m.%d.%y', '%m.%d.%Y', '%m/%d/%y'],
        'pagination': '?PageNum_rs={page}&',
    },
    'grassley': {
        'method': 'generic',
        'url_base': 'https://www.grassley.senate.gov/news/news-releases',
        'container': 'li.PageList__item',
        'title_sel': 'a.PressBlock__title',
        'date_sel': 'p.PressBlock__date',
        'date_fmt': ['%m.%d.%Y', '%m/%d/%y', '%B %d, %Y'],
        'pagination': '?pagenum_rs={page}',
    },
    ...
    'bera': {
        'method': 'generic',
        'url_base': 'https://bera.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'a',
        'date_sel': 'time',
        'date_attr': 'datetime',
        'date_fmt': ['%Y-%m-%d'],
        'pagination': '?DocumentTypeID=2402&Page={page}',
        'url_prefix': '/news/',
    },
    'brownley': {
        'method': 'generic',
        'url_base': 'https://brownley.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=2519&Page={page}',
        'url_prefix': '/news/',
    },
    'castor': {
        'method': 'generic',
        'url_base': 'https://castor.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'a',
        'date_sel': 'time',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?DocumentTypeID=821&Page={page}',
        'url_prefix': '/news/',
    },
    'connolly': {
        'method': 'generic',
        'url_base': 'https://connolly.house.gov/news/documentquery.aspx',
        'container': '.news-texthold',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?DocumentTypeID=1952&Page={page}',
        'url_prefix': '/news/',
    },
    'emmer': {
        'method': 'generic',
        'url_base': 'https://emmer.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=2516&Page={page}',
        'url_prefix': '/news/',
    },
    'foxx': {
        'method': 'generic',
        'url_base': 'https://foxx.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=1525&Page={page}',
        'url_prefix': '/news/',
    },
    'gosar': {
        'method': 'generic',
        'url_base': 'https://gosar.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
    ...
    'griffith': {
        'method': 'generic',
        'url_base': 'https://griffith.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
    ...
    'houlahan': {
        'method': 'generic',
        'url_base': 'https://houlahan.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=2545&Page={page}',
        'url_prefix': '/news/',
    },
    'huizenga': {
        'method': 'generic',
        'url_base': 'https://huizenga.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
    ...
    'jasonsmith': {
        'method': 'generic',
        'url_base': 'https://jasonsmith.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=1545&Page={page}',
        'url_prefix': '/news/',
    },
    'larsen': {
        'method': 'generic',
        'url_base': 'https://larsen.house.gov/news/documentquery.aspx',
        'container': '.news-texthold',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_fmt': ['%B %d, %Y'],
    ...
    'mast': {
        'method': 'generic',
        'url_base': 'https://mast.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=2526&Page={page}',
        'url_prefix': '/news/',
    },
    'mcgovern': {
        'method': 'generic',
        'url_base': 'https://mcgovern.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
    ...
    'norcross': {
        'method': 'generic',
        'url_base': 'https://norcross.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
    ...
    'porter': {
        'method': 'generic',
        'url_base': 'https://porter.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=2581&Page={page}',
        'url_prefix': '/news/',
    },
    'schweikert': {
        'method': 'generic',
        'url_base': 'https://schweikert.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=1530&Page={page}',
        'url_prefix': '/news/',
    },
    'titus': {
        'method': 'generic',
        'url_base': 'https://titus.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
        'date_fmt': ['%m/%d/%Y', '%m/%d/%y'],
        'pagination': '?DocumentTypeID=1510&Page={page}',
        'url_prefix': '/news/',
    },
    'tlaib': {
        'method': 'generic',
        'url_base': 'https://tlaib.house.gov/news/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h2 a',
        'date_sel': 'span.middot',
        'date_from_next_sibling': True,
    ...
    'tonko': {
        'method': 'generic',
        'url_base': 'https://tonko.house.gov/news/documentquery.aspx',
        'container': '.news-texthold',
        'title_sel': 'h2 a',
        'date_sel': 'time',
        'date_fmt': ['%B %d, %Y'],
    ...
    'trentkelly': {
        'method': 'generic',
        'url_base': 'https://trentkelly.house.gov/newsroom/documentquery.aspx',
        'container': 'article',
        'title_sel': 'h3',
        'link_sel': 'a',
        'date_sel': 'time',
    ...
    'budd': {
        'method': 'generic',
        'url_base': 'https://www.budd.senate.gov/category/news/press-releases/page/',
        'container': 'article.et_pb_post',
        'title_sel': 'h2 a',
        'date_sel': 'p span.published',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '{page}/?et_blog',
    },
    'hagerty': {
        'method': 'generic',
        'url_base': 'https://www.hagerty.senate.gov/press-releases/',
        'container': 'article.et_pb_post',
        'title_sel': 'h2 a',
        'date_sel': 'p span.published',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?et_blog&sf_paged={page}',
    },
    'gillibrand': {
        'method': 'generic',
        'url_base': 'https://www.gillibrand.senate.gov/press-releases/page/',
        'container': '.et_pb_ajax_pagination_container article',
        'title_sel': 'h2 a',
        'date_sel': 'p.published',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '{page}/',
    },
    'lummis': {
        'method': 'generic',
        'url_base': 'https://www.lummis.senate.gov/press-releases/page/',
        'container': 'article.et_pb_post',
        'title_sel': 'h2 a',
        'date_sel': 'p span.published',
        'date_fmt': ['%B %d, %Y'],
    ...
    'rubio': {
        'method': 'generic',
        'url_base': 'https://www.rubio.senate.gov/news/page/',
        'container': 'article.et_pb_post',
        'title_sel': 'h3 a',
        'date_sel': 'p span.published',
        'date_fmt': ['%B %d, %Y'],
    ...
    'jeffries': {
        'method': 'generic',
        'url_base': 'https://jeffries.house.gov/category/press-release/page/',
        'container': 'article',
        'title_sel': 'h1',
        'link_sel': 'a',
        'date_sel': 'time',
    ...
    'murray': {
        'method': 'generic',
        'url_base': 'https://www.murray.senate.gov/category/press-releases/page/',
        'container': 'article',
        'title_sel': 'h3 a',
        'date_sel': 'time.date',
        'date_fmt': ['%B %d, %Y'],
    ...
    'rickscott': {
        'method': 'generic',
        'url_base': 'https://www.rickscott.senate.gov/category/press-releases/page/',
        'container': 'article',
        'title_sel': 'h3 a',
        'date_sel': 'time.date',
        'date_fmt': ['%B %d, %Y'],
    ...
    'welch': {
        'method': 'generic',
        'url_base': 'https://www.welch.senate.gov/category/press-release/page/',
        'container': 'article',
        'title_sel': 'h2',
        'link_sel': 'a',
        'date_sel': '.postDate span',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '{page}/',
    },
    ...
    'britt': {
        'method': 'generic',
        'url_base': 'https://www.britt.senate.gov/media/press-releases/',
        'container': '.jet-listing-grid__item',
        'title_sel': 'h3 a',
        'date_sel': 'h3.elementor-heading-title',
        'date_fmt': ['%m.%d.%Y', '%m/%d/%Y'],
        'pagination': '?jsf=jet-engine:press-list&pagenum={page}',
    },
    'fetterman': {
        'method': 'generic',
        'url_base': 'https://www.fetterman.senate.gov/press-releases/',
        'container': '.jet-listing-grid__item',
        'title_sel': 'h3 a',
    ...
    'jayapal': {
        'method': 'generic',
        'url_base': 'https://jayapal.house.gov/newsroom/press-releases/',
        'container': '.jet-listing-grid__item',
        'title_sel': 'h5 a',
        'date_sel': 'span.elementor-icon-list-text',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?jsf=jet-engine&tax=press_cat:16&pagenum={page}',
    },
    'markkelly': {
        'method': 'generic',
        'url_base': 'https://www.kelly.senate.gov/newsroom/press-releases/',
        'container': 'div.jet-listing-grid__item',
        'title_sel': 'h3 a',
        'date_sel': 'span.elementor-post-info__item--type-date',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?jsf=jet-engine:press-list&pagenum={page}',
    },
    'mullin': {
        'method': 'generic',
        'url_base': 'https://www.mullin.senate.gov/newsroom/press-releases',
        'container': '.jet-listing-grid__item',
        'title_sel': 'a',
        'date_sel': 'span.elementor-post-info__item--type-date',
        'date_fmt': ['%m.%d.%y', '%m/%d/%y'],
    ...
    'tester': {
        'method': 'generic',
        'url_base': 'https://www.tester.senate.gov/newsroom/press-releases/',
        'container': '.jet-listing-grid__item',
        'title_sel': 'h3 a',
        'date_sel': 'span.elementor-icon-list-text',
        'date_fmt': ['%B %d, %Y'],
    ...
    'tuberville': {
        'method': 'generic',
        'url_base': 'https://www.tuberville.senate.gov/press-releases/',
        'container': '.jet-listing-grid__item',
        'title_sel': 'h3 a',
        'date_sel': 'span.elementor-icon-list-text',
        'date_fmt': ['%B %d, %Y'],
    ...
    'crawford': {
        'method': 'generic',
        'url_base': 'https://crawford.house.gov/media-center/press-releases',
        'container': 'tr',
        'title_sel': 'td a',
        'date_sel': 'time',
        'date_fmt': ['%m/%d/%y'],
    ...
    'grijalva': {
        'method': 'generic',
        'url_base': 'https://grijalva.house.gov/media-center/press-releases',
        'container': 'tr',
        'title_sel': 'td a',
        'date_sel': 'time',
        'date_fmt': ['%m/%d/%y'],
    ...
    'scanlon': {
        'method': 'generic',
        'url_base': 'https://scanlon.house.gov/media/press-releases',
        'container': 'tr',
        'title_sel': 'td a',
        'date_sel': 'time',
        'date_fmt': ['%m/%d/%y'],
    ...
    'takano': {
        'method': 'generic',
        'url_base': 'https://takano.house.gov/newsroom/press-releases',
        'container': 'tr',
        'title_sel': 'td a',
        'date_sel': 'time',
        'date_fmt': ['%m/%d/%y'],
    ...
    'bennet': {
        'method': 'generic',
        'url_base': 'https://www.bennet.senate.gov/public/index.cfm/press-releases',
    ...
    'hoeven': {
        'method': 'generic',
        'url_base': 'https://www.hoeven.senate.gov/public/index.cfm/news-releases',
        'container': 'table tbody tr',
        'title_sel': 'a',
        'date_sel': 'td time',
        'date_fmt': ['%m/%d/%y'],
    ...
    'warner': {
        'method': 'generic',
        'url_base': 'https://www.warner.senate.gov/public/index.cfm',
        'container': 'table tbody tr',
        'title_sel': 'a',
        'date_sel': 'td time',
        'date_fmt': ['%m/%d/%y'],
        'pagination': '?p=press-releases&page={page}',
    },

    # Other convertible patterns
    'angusking': {
        'method': 'generic',
        'url_base': 'https://www.king.senate.gov/newsroom/press-releases/table',
        'container': '.press-browser__item-row',
        'title_sel': 'a',
        'date_sel': 'time',
        'date_attr': 'datetime',
        'date_fmt': ['%Y-%m-%d'],
    ...
    'barragan': {
        'method': 'generic',
        'url_base': 'https://barragan.house.gov/category/news-releases/page/',
        'container': '.post',
        'title_sel': 'h2',
        'link_sel': 'a',
        'date_sel': 'p',
    ...
    'clyburn': {
        'method': 'generic',
        'url_base': 'https://clyburn.house.gov/press-releases/',
    ...
    'hawley': {
        'method': 'generic',
        'url_base': 'https://www.hawley.senate.gov/press-releases/page/',
        'container': 'article .post',
        'title_sel': 'h2 a',
        'date_sel': 'span.published',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '{page}/',
    },
    'meeks': {
        'method': 'generic',
        'url_base': 'https://meeks.house.gov/media/press-releases',
        'container': '.views-row',
        'title_sel': 'a.h4',
    ...
    'steube': {
        'method': 'generic',
        'url_base': 'https://steube.house.gov/category/press-releases/page/',
    ...
    'sykes': {
        'method': 'generic',
        'url_base': 'https://sykes.house.gov/media/press-releases',
        'container': 'table#browser_table tbody tr',
        'title_sel': 'a',
        'date_sel': 'time',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '?PageNum_rs={page}',
    ...
    'tinasmith': {
        'method': 'generic',
        'url_base': 'https://www.smith.senate.gov/media/press-releases',
        'container': 'div.ArticleBlock',
        'title_sel': 'h2 a',
        'date_sel': 'p',
        'date_fmt': ['%m.%d.%Y', '%m/%d/%y'],
    ...
    'vance': {
        'method': 'generic',
        'url_base': 'https://www.vance.senate.gov/press-releases/page/',
        'container': '.elementor .post',
        'title_sel': 'h2 a',
        'date_sel': 'span.elementor-post-info__item--type-date',
        'date_fmt': ['%B %d, %Y'],
        'pagination': '{page}/',
    ...
    'vanhollen': {
        'method': 'generic',
        'url_base': 'https://www.vanhollen.senate.gov/news/press-releases',
        'container': 'ul li.PageList__item',
        'title_sel': 'a',
        'date_sel': 'p',
        'date_fmt': ['%m/%d/%y', '%m.%d.%y'],
        'pagination': '?pagenum_rs={page}',
    ...
    'curtis': {'method': 'generic', 'url_base': 'https://www.curtis.senate.gov/newsroom/press-releases', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_fmt': ['%B %d, %Y', '%Y-%m-%d'], 'pagination': '?page={page}'},
    ...
    'justice': {'method': 'generic', 'url_base': 'https://www.justice.senate.gov/newsroom/press-releases', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_fmt': ['%B %d, %Y', '%Y-%m-%d'], 'pagination': '?page={page}'},
    'kim': {'method': 'generic', 'url_base': 'https://www.kim.senate.gov/newsroom/press-releases', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_fmt': ['%B %d, %Y', '%Y-%m-%d'], 'pagination': '?page={page}'},
    ...
    'moreno': {'method': 'generic', 'url_base': 'https://www.moreno.senate.gov/newsroom/press-releases', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_fmt': ['%B %d, %Y', '%Y-%m-%d'], 'pagination': '?page={page}'},
    ...
    'rosen': {'method': 'generic', 'url_base': 'https://www.rosen.senate.gov/press-releases', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_fmt': ['%B %d, %Y', '%Y-%m-%d'], 'pagination': ''},
    ...
    'schmitt': {'method': 'jet_listing_elementor', 'url_base': 'https://www.schmitt.senate.gov/newsroom/press-releases'},
