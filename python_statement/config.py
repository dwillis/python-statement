...
SCRAPER_CONFIG = {
    ...
    'markey': {'method': 'generic', 'url_base': 'https://www.markey.senate.gov/news/press-releases', 'container': 'div.ArticleBlock', 'title_sel': 'a.ArticleBlock__title__link', 'date_sel': 'p.ArticleBlock__date', 'date_fmt': ['%B %d, %Y']},
    ...
    'ernst': {'method': 'generic', 'url_base': 'https://www.ernst.senate.gov/news/press-releases', 'container': 'div.ArticleBlock', 'title_sel': 'a', 'date_sel': 'p.Heading--time', 'date_fmt': ['%B %d, %Y']},
    ...
    'pressley': {'method': 'generic', 'url_base': 'https://pressley.house.gov/news/', 'container': 'a.post', 'title_sel': 'p.title', 'date_sel': 'p.date', 'date_fmt': ['%b %d, %Y', '%B %d, %Y']},
    ...
    'ronjohnson': {'method': 'generic', 'url_base': 'https://www.ronjohnson.senate.gov/press-releases', 'container': 'div.element', 'title_sel': 'div.element-title', 'link_sel': 'a', 'date_sel': 'span.element-datetime', 'date_fmt': ['%m/%d/%Y']},
    ...
    'hamadeh': {'method': 'generic', 'url_base': 'https://hamadeh.house.gov/news/', 'container': 'article.newsblocker', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_attr': 'datetime', 'date_fmt': ['%Y-%m-%d'], 'url_prefix': '/news/'},
    ...
    'goodlander': {'method': 'generic', 'url_base': 'https://goodlander.house.gov/media/press-releases/', 'container': 'li.post', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_attr': 'datetime', 'date_fmt': ['%Y-%m-%dT%H:%M:%S+00:00']},
    ...
    'houlahan': {'method': 'generic', 'url_base': 'https://houlahan.house.gov/press/', 'container': 'article.newsblocker', 'title_sel': 'strong.title a', 'date_sel': 'span.date'},
    ...
    'mcgovern': {'method': 'generic', 'url_base': 'https://mcgovern.house.gov/news/', 'container': 'article.newsblocker', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_attr': 'datetime', 'date_fmt': ['%Y-%m-%dT%H:%M:%S'], 'url_prefix': '/news/'},
    ...
    'scanlon': {'method': 'generic', 'url_base': 'https://scanlon.house.gov/news/', 'container': 'article.newsblocker', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_attr': 'datetime', 'date_fmt': ['%Y-%m-%d'], 'url_prefix': '/news/'},
    ...
    'tinasmith': {'method': 'generic', 'url_base': 'https://www.smith.senate.gov/media/press-releases/', 'container': 'article.elementor-post', 'title_sel': 'h3.elementor-post__title a', 'date_sel': 'span.elementor-post-date', 'date_fmt': ['%B %d, %Y']},
    ...
    'arrington': {'method': 'generic', 'url_base': 'https://arrington.house.gov/press-releases', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_fmt': ['%B %d, %Y', '%Y-%m-%d'], 'pagination': '?page={page}'},
    ...
    'davidscott': {'method': 'generic', 'url_base': 'https://davidscott.house.gov/news', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_fmt': ['%B %d, %Y', '%Y-%m-%d'], 'pagination': '?page={page}'},
    ...
    'gonzales': {'method': 'table_recordlist_date', 'url_base': 'https://gonzales.house.gov/press-releases'},
    ...
    'justice': {'method': 'generic', 'url_base': 'https://www.justice.senate.gov/newsroom/press-releases', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'span.elementor-post-date', 'date_fmt': ['%B %d, %Y'], 'pagination': '?page={page}'},
    ...
    'morgangriffith': {'method': 'generic', 'url_base': 'https://morgangriffith.house.gov/news', 'container': 'article', 'title_sel': 'h2 a', 'date_sel': 'time', 'date_fmt': ['%B %d, %Y', '%Y-%m-%d'], 'pagination': '?page={page}'},
    ...
    'schmitt': {'method': 'generic', 'url_base': 'https://www.schmitt.senate.gov/newsroom/press-releases/', 'container': '.jet-listing-grid__item', 'title_sel': 'a.jet-listing-dynamic-link__link', 'date_sel': '.overline h3', 'date_fmt': ['%B %d, %Y']},
    ...
    'himes': {'method': 'generic', 'url_base': 'https://himes.house.gov/press-releases', 'container': '.post-media-digest-item', 'title_sel': '.post-media-digest-title', 'link_sel': 'a.media-digest-body-link', 'date_sel': '.post-media-digest-date', 'date_fmt': ['%B %d, %Y', '%B %d'], 'pagination': '?page={page}'},
